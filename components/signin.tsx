  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center items-center">
      <div className="max-w-screen-xl bg-white shadow rounded-lg p-6 sm:p-12 flex flex-col items-center">
        <h1 className="text-2xl xl:text-3xl font-extrabold mb-8">Sign In</h1>
        ...
        <div className="mx-auto max-w-xs w-full">
          ...
          {error && (
            <div className="text-center text-red-500 text-xl font-medium mt-4">
              {error}
            </div>
          )}
          {success && (
            <div className="text-center text-green-500 text-xl font-medium mt-4">
              {success}
            </div>
          )}
        </div>
